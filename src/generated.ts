// Generated by @wagmi/cli@1.2.0 on 6/18/2023 at 4:07:48 AM
import {
  useContractWrite,
...
export const registryFactoryABI = [
  ...
  },
  {
    ...
    type: 'function',
    inputs: [{ name: '_user', internalType: 'address', type: 'address' }],
    name: 'getUserRegistryAddresses',
    outputs: [
      { name: '_registries', internalType: 'address[]', type: 'address[]' },
    ],
  },
  {
    stateMutability: 'view',
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link registryABI}__ and `functionName` set to `"getVaults"`.
 */
export function useRegistryGetVaults<
  TFunctionName extends 'getVaults',
  TSelectData = ReadContractResult<typeof registryABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof registryABI, TFunctionName, TSelectData>,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link registryABI}__ and `functionName` set to `"vaultInfo"`.
 */
export function useRegistryVaultInfo<
  TFunctionName extends 'vaultInfo',
  TSelectData = ReadContractResult<typeof registryABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof registryABI, TFunctionName, TSelectData>,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link registryABI}__ and `functionName` set to `"vaultSafes"`.
 */
export function useRegistryVaultSafes<
  TFunctionName extends 'vaultSafes',
  TSelectData = ReadContractResult<typeof registryABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof registryABI, TFunctionName, TSelectData>,
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link registryABI}__ and `functionName` set to `"createVault"`.
 */
export function useRegistryCreateVault<
  TMode extends WriteContractMode = undefined,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
    ...
    : UseContractWriteConfig<typeof registryABI, 'createVault', TMode> & {
        abi?: never
        functionName?: 'createVault'
      } = {} as any,
) {
  return useContractWrite<typeof registryABI, 'createVault', TMode>({
    abi: registryABI,
    functionName: 'createVault',
    ...config,
  } as any)
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link registryABI}__ and `functionName` set to `"createVault"`.
 */
export function usePrepareRegistryCreateVault(
  config: Omit<
    UsePrepareContractWriteConfig<typeof registryABI, 'createVault'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'createVault',
    ...config,
  } as UsePrepareContractWriteConfig<typeof registryABI, 'createVault'>)
}
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link registryFactoryABI}__ and `functionName` set to `"getUserRegistryAddresses"`.
 */
export function useRegistryFactoryGetUserRegistryAddresses<
  TFunctionName extends 'getUserRegistryAddresses',
  TSelectData = ReadContractResult<typeof registryFactoryABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<
  ...
  return useContractRead({
    abi: registryFactoryABI,
    functionName: 'getUserRegistryAddresses',
    ...config,
  } as UseContractReadConfig<
    typeof registryFactoryABI,
    TFunctionName,
